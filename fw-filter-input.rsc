...
add address=192.168.86.0/23 list=ftp_open
add address=192.168.86.0/23 list=snmp_allow
...
add action=drop chain=input comment=DNS dst-port=53 in-interface-list=abb protocol=udp
...
add action=drop chain=input comment="drop bogons" in-interface-list=abb src-address-list=bogons
add action=drop chain=input comment="drop large" disabled=yes log=yes log-prefix=LLL packet-size=!0-1500
add action=drop chain=input comment=bfd disabled=yes dst-port=3784 in-interface-list=abb protocol=udp
...
add action=accept chain=input comment=l2tp dst-port=1701 in-interface-list=abb protocol=udp
add action=accept chain=input comment=pptp dst-port=1723 in-interface-list=abb protocol=tcp
add action=accept chain=input comment=gre in-interface-list=abb protocol=gre
add action=accept chain=input comment="Winbox MAC" dst-port=20561 in-interface-list=!abb protocol=udp
...
add action=accept chain=input comment=dhcp dst-port=67 in-interface-list=!abb protocol=udp
add action=accept chain=input dst-port=68 in-interface-list=!abb protocol=udp
...
add action=drop chain=input comment=neighbour dst-port=5678 in-interface-list=abb protocol=udp
